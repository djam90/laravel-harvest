...
class InvoiceService extends BaseService
{
     ...
     *
     * @param int|null $clientId Only return invoices belonging to the client with the given ID.
     * @param int|null $projectId Only return invoices associated with the project with the given ID.
     ...
     * @return mixed
     */
    public function get($clientId = null, $projectId = null, $updatedSince = null, $page = 1, $perPage = 100)
    {
        $uri = "invoices";
     ...
     *
     * @param int $clientId The ID of the client this invoice belongs to.
     * @param int|null $retainerId The ID of the retainer associated with this invoice.
     * @param int|null $estimateId The ID of the estimate associated with this invoice.
     ...
     * @param string|null $currency The currency used by the invoice. If not provided, the client’s currency will be used.
     ...
     *
     * @var int $project_id The ID of the project associated with this line item. (optional)
     ...
     * @var int $quantity The unit quantity of the item. Defaults to 1. (optional)
     ...
     * @return mixed
     */
    public function create($clientId, $retainerId = null, $estimateId = null, $number = null,
                           $purchaseOrder = null, $tax = null, $tax2 = null, $discount = null, $subject = null,
                           $notes = null, $currency = null, $issueDate = null, $dueDate = null,
                           $lineItems = null)
    {
        $uri = "invoices";
     ...
     * Update an invoice.
     *
     * Updates the specific invoice by setting the values of the parameters passed. Any parameters not provided will be
     * left unchanged. Returns an invoice object and a 200 OK response code if the call succeeded.
     *
     * For tax, tax2, and discount use 10.0 for 10.0%.
     *
     * @param int $invoiceId The invoice ID.
     * @param int|null $clientId The ID of the client this invoice belongs to.
     * @param int|null $retainerId The ID of the retainer associated with this invoice.
     * @param int|null $estimateId The ID of the estimate associated with this invoice.
     * @param string|null $number If no value is set, the number will be automatically generated.
     * @param string|null $purchaseOrder The purchase order number.
     ...
     * @return mixed
     */
    public function update($invoiceId, $clientId, $retainerId = null, $estimateId = null, $number = null,
                           $purchaseOrder = null, $tax = null, $tax2 = null, $discount = null, $subject = null,
                           $notes = null, $currency = null, $issueDate = null, $dueDate = null,
                           $lineItems = null)
    {
     ...
     * @param int|null $projectId The ID of the project associated with this line item.
     * @param string|null $description The name of an invoice item category.
     * @param int|null $quantity The unit quantity of the item. Defaults to 1.
     * @param bool|null $taxed Whether the invoice’s tax percentage applies to this line item. Defaults to false.
     * @param bool|null $taxed2 Whether the invoice’s tax2 percentage applies to this line item. Defaults to false.
     *
     * @return mixed
     */
    public function createLineItem($invoiceId, $kind, $unitPrice, $projectId = null, $description = null,
                                      $quantity = null, $taxed = null, $taxed2 = null)
    {
        $uri = "invoices/" . $invoiceId;
        ...
        if (!is_null($projectId)) $data['line_items'][0]['project_id'] = $projectId;
        if (!is_null($description)) $data['line_items'][0]['description'] = $description;
     ...
     *
     * @param int $invoiceId The invoice ID.
     * @param int $lineItemId The ID of the line item being updated.
     * @param string $kind The name of an invoice item category.
     * @param float $unitPrice The individual price per unit.
     * @param int|null $projectId The ID of the project associated with this line item.
     * @param string|null $description The name of an invoice item category.
     ...
     * @return mixed
     */
    public function updateLineItem($invoiceId, $lineItemId, $kind = null, $unitPrice = null, $projectId = null,
                                          $description = null, $quantity = null, $taxed = null, $taxed2 = null)
    {
        $uri = "invoices/" . $invoiceId;
        ...
        if (!is_null($unitPrice)) $data['line_items'][0]['unit_price'] = $unitPrice;
        if (!is_null($projectId)) $data['line_items'][0]['project_id'] = $projectId;
        if (!is_null($description)) $data['line_items'][0]['description'] = $description;
        if (!is_null($quantity)) $data['line_items'][0]['quantity'] = $quantity;
        if (!is_null($taxed)) $data['line_items'][0]['taxed'] = $taxed;
     ...
     *
     * @param int $invoiceId The ID of the invoice where the line item is to be deleted from.
     * @param int $lineItemId The ID of the invoice line item being deleted.
     *
     * @return mixed
     */
     ...
     *
     * @param int $invoiceId The ID of the invoice to be deleted.
     *
     * @return mixed
     */
